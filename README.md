...
HTML, CSS, JavaScript (Frontend) and Node.js, Express, MySQL (Backend).

This project supports Admin and Student roles with separate privileges.
...
You can run this script in MySQL Workbench or your preferred MySQL client.
...
Admin and Student dashboards share the same layout but different permissions
...
For testing, run both backend (node server.js) and frontend (open index.html in browser).

This version doesn’t include a unique student_id; it tracks issued books by student_name.
